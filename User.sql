...
INSERT INTO `客户表` (`客户号`, `客户名`, `性别`, `区域`, `行业`, `联系方式`, `集团`, `违约情况`) VALUES
	('1', '张三', '男', '北京', '学生', '110', 'HDU', b'0'),
	('2', '李四', '未知', '杭州', '学生', '120', 'HDU', b'0'),
	('3', '王五', '女', '杭州', '学生', '130', 'AAA', b'0');
...
INSERT INTO `违约风险原因表` (`违约原因编号`, `违约原因`, `是否启用`) VALUES
	('1', '6 个月内，交易对手技术性或资金等原因，给当天结算带来头寸缺口 2 次以上', b'1'),
	('2', '未能按照合约规定支付或延期支付利息，本金或其他交付义务（不包括在宽限期内延期支付）', b'1'),
	('3', '6 个月内因各种原因导致成交后撤单 2 次以上', b'1'),
	('4', '关联违约：如果集团（内部联系较紧密的集团）或集团内任一公司（较重要的子公司，一旦发生违约会对整个集团造成较大影响的）发生违约，可视情况作为集团内所有成员违约的触发条件', b'1'),
	('5', '发生消极债务置换：债务人提供给债权人新的或重组的债务，或新的证券组合、现金或资产低于原有金融义务；或为了债务人未来避免发生破产或拖欠还款而进行的展期或重组', b'1'),
	('6', '申请破产保护，发生法律接管，或者处于类似的破产保护状态', b'1'),
	('7', '在其他金融机构违约（包括不限于：人行征信记录中显示贷款分类状态不良类情况，逾期超过 90 天等），或外部评级显示为违约级别', b'1');
