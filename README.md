...
| 版本            | 新增功能简介           |
| --------------- | ---------------------- |
| Web_Projects0.1 | 网站 UI 等设计完成     |
| Web_Projects0.2 | 完成违约认定审核页面   |
| Web_Projects0.3 | 完成违约重生审核页面   |
| Web_Projects0.4 | 完成信息查询页面       |
| Web_Projects0.5 | 与后端对接进行功能测试 |
| Web_Projects0.6 | 美化页面完善部分功能   |

### 后端

| 版本   | 新增功能简介                   |
| ------ | ------------------------------ |
| v0.0.1 | 违约申请 api 基本完成          |
| v0.0.2 | 与数据库对接                   |
| v0.1.0 | 完成 重生接口 & 完善数据库定义 |
| v0.1.1 | 新增路由 & 初步对接前端        |
| v0.1.2 | 完善数据库定义                 |
| v0.1.3 | 完成 mysql 初始化文件 User.sql |
| v0.1.4 | 前后端接口对接基本完成         |
